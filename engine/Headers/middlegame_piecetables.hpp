...
inline std::array<int,64> mg_queen_table = {
...
inline std::array<int,64> mg_rook_table = {
...
inline std::array<int,64> mg_bishop_table = {
...
inline std::array<int,64> mg_knight_table = {
...
inline std::array<int,64> mg_pawn_table = {
    0, 0, 0, 0, 0, 0, 0, 0,
